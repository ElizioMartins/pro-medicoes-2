...
export async function initializeDatabase(
  ...
  // Inicialização de dados padrão agora é feita exclusivamente pelo backend (init_db.py)
  // Esta função foi desabilitada para evitar duplicidade e erros de conflito.
  // Caso precise popular dados de teste via frontend, reabilite manualmente.
}
*/
